...
const create_theme = async (ctx, canvas, theme, W) => {
  ...
  switch (theme) {
    case "dark":
      theme_obj.background = await generateGradient(
        GradientConstants.DARK_1,
        ctx,
        canvas,
        W
      );
